...
dev.off()
file.copy("output/plots/mice.pdf", "manuscript/figures/", recursive = TRUE)
...
dev.off()
file.copy("output/plots/imputation_check_gdp.pdf", "manuscript/figures", recursive = TRUE)
...
dev.off()
file.copy("output/plots/imputation_check_sd.pdf", "manuscript/figures", recursive = TRUE)
